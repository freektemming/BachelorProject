...
def huntermass(model1, model2, model3, model4, typ, number):
    ...
    # plot line
    if typ == 'N':
        ax.plot(model1.vrot[0:lim1], model1.nnit[0:lim1], lw = 1, color = 'black', linestyle = 'solid', label = 'Vink 01')
        ax.plot(model2.vrot[0:lim2], model2.nnit[0:lim2], lw = 1, color = 'black', linestyle = 'dashed', label = 'Vink 18')
        ax.plot(model3.vrot[0:lim3], model3.nnit[0:lim3], lw = 1, color = 'black', linestyle = 'dashdot', label = 'Leuven')
        ax.plot(model4.vrot[0:lim4], model4.nnit[0:lim4], lw = 1, color = 'black', linestyle = 'dotted', label = 'Krticka')
    ...
    if typ == 'N':
        ims1 = ax.scatter(model1.vrot[0:lim1], model1.nnit[0:lim1], c= model1.age[0:lim1], marker='o', edgecolors='none', s=100, cmap=colormap, vmin = model1.get_min_bar(), vmax = model1.get_age(lim1))
        ims2 = ax.scatter(model2.vrot[0:lim2], model2.nnit[0:lim2], c= model2.age[0:lim2], marker='o', edgecolors='none', s=100, cmap=colormap, vmin = model1.get_min_bar(), vmax = model1.get_age(lim1))       
        ims3 = ax.scatter(model3.vrot[0:lim3], model3.nnit[0:lim3], c= model3.age[0:lim3], marker='o', edgecolors='none', s=100, cmap=colormap, vmin = model1.get_min_bar(), vmax = model1.get_age(lim1))
        ims4 = ax.scatter(model4.vrot[0:lim4], model4.nnit[0:lim4], c= model4.age[0:lim4], marker='o', edgecolors='none', s=100, cmap=colormap, vmin = model1.get_min_bar(), vmax = model1.get_age(lim1))       
