...
def plotcore(model1, model2, model3, model4, number, ms):
    ...
    # ------ Plot Lines ------
    ax.plot(model1.time[0:lim1], model1.nmass[0:lim1], lw = 1, color = 'black', linestyle = 'solid')
    ax.plot(model2.time[0:lim2], model2.nmass[0:lim2], lw = 1, color = 'black', linestyle = 'dashed')
    ax.plot(model3.time[0:lim3], model3.nmass[0:lim3], lw = 1, color = 'black', linestyle = 'dashdot')
    ax.plot(model4.time[0:lim4], model4.nmass[0:lim4], lw = 1, color = 'black', linestyle = 'dotted')
